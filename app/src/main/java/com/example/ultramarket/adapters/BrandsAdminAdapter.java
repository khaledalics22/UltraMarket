...
public class BrandsAdminAdapter extends RecyclerView.Adapter<BrandsAdminAdapter.BrandVH> {
    ...
    private BrandsAdminAdapter.OnItemClickListener mListener;
     ...
     */
    public void setOnItemClickListener(BrandsAdminAdapter.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    class BrandVH extends RecyclerView.ViewHolder {
        ...
        public BrandVH(@NonNull final View itemView, final BrandsAdminAdapter.OnItemClickListener listener) {
            super(itemView);
